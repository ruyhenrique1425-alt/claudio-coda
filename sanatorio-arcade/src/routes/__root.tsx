  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Ala não encontrada</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Esse leito não existe ou foi transferido.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo falhou aqui do nosso lado. Tente de novo ou volte para a triagem.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sanatório — Ala de Festas" },
      {
        ...
        content: "Prontuário de admissão, mural dos internos, câmera e arcade.",
      },
